...
export async function GET() {
    const quotes = [
      ...
      { content: "The only limit is your mind.", author: "Unknown" },
      ...
      { content: "Do not wait for leaders. Do it alone, person to person.", author: "Mother Teresa" },
      { content: "Everything has beauty, but not everyone sees it.", author: "Confucius" },
      { content: "Limit your 'always' and your 'nevers'.", author: "Amy Poehler" },
      { content: "Nothing will work unless you do.", author: "Maya Angelou" },
      { content: "We can do anything we want to if we stick to it long enough.", author: "Helen Keller" },
      ...
      { content: "You get what you give.", author: "Jennifer Lopez" },
